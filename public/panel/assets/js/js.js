...
function create_custom_dropdowns() {
    $('.custom-select-box-js').each(function (i, select) {
...
function acceptSelectedLessons(route) {
    var allVals = [];
...
function rejectSelectedLessons(route) {
    var allVals = [];
    $(".sub-checkbox:checked").each(function () {
        allVals.push($(this).attr('data-id'));
    });
...
function acceptMultiple(route) {
    doMultipleAction(route,"آیا مطمئن هستید که می خواهید این سطر را تایید کنید؟", "put")
}
function rejectMultiple(route) {
    doMultipleAction(route,"آیا مطمئن هستید که می خواهید این سطر را رد کنید؟", "put")
}

function deleteMultiple(route) {
    doMultipleAction(route,"آیا مطمئن هستید که می خواهید این سطر را حذف کنید؟", "delete")
}
